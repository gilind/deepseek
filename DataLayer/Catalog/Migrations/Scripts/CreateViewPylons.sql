/****** Object:  View [dbo].[PylonsFormat2011]    Script Date: 30.10.2012 23:28:39 ******/
CREATE VIEW [dbo].[PylonsFormat2011]
AS
SELECT     ID AS ObjectId, Type AS ankern, Code AS shifr_op, Sheme AS sxema_op, BaseX AS base_x, BaseY AS base_y, LugBottomLeftTraverse AS v_n_lev, 
                      ...
                      RackButtDiameter AS diametr, Height AS l_stoik, HeightBottomTraverse AS h1, HeightMiddleTraverse AS h2, HeightTopTraverse AS h3, 
                      LugMiddleLeftTraverse AS v_sr_lev, LugMiddleRightTraverse AS v_sr_pr, MiddleLeftTraverse AS sr_lev_tr, MiddleRightTraverse AS sr_pr_tr, 
                      ...
                      IsGalvanized AS use_cink, Voltage / 1000 AS Voltage
FROM dbo.Pylons
