namespace Ru.DataLayer.DatabaseHelpers
{
    ...
    /// Модфикация стандартного класса NpgsqlCommandBuilder для работы NpgsqlBatchDataAdapter
    ///</summary>
    [System.ComponentModel.DesignerCategory("")]
    public sealed class NpgsqlCustomCommandBuilder : DbCommandBuilder
    {
        ...
        /// </summary>
        public NpgsqlCustomCommandBuilder()
            : this(null)
        {
        }
        ...
        public NpgsqlCustomCommandBuilder(NpgsqlBatchDataAdapter adapter)
        {
            DataAdapter = adapter;
            QuotePrefix = "\"";
            QuoteSuffix = "\"";
...
*/
        ...
        {
            var npgsqlAdapter = adapter as NpgsqlBatchDataAdapter;
            ...
            if (adapter == DataAdapter)
                ...
                npgsqlAdapter.RowUpdating -= NpgsqlAdapterOnRowUpdating;
            else
                npgsqlAdapter.RowUpdating += NpgsqlAdapterOnRowUpdating;
        }

        private void NpgsqlAdapterOnRowUpdating( object sender, DatabaseHelpers.NpgsqlRowUpdatingEventArgs npgsqlRowUpdatingEventArgs )
        {
            base.RowUpdatingHandler( npgsqlRowUpdatingEventArgs );
        }
        ...
        /// <param name="e">A <see cref="Npgsql.NpgsqlRowUpdatingEventArgs"/> instance containing information about the event.</param>
        void RowUpdatingHandler(object sender, Npgsql.NpgsqlRowUpdatingEventArgs e) => base.RowUpdatingHandler(e);
